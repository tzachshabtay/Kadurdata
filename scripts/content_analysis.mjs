...
function teamMechanismSummary(team, shots, players, units, spatialTeam, distortionMinute) {
  ...
  return {
    ...
    shotsAtLeastPointTwoXg: highQuality.length,
    expectedGoalsFromShotsAtLeastPointTwoXg: round(highQuality.reduce((sum, shot) => sum + Number(shot.xg ?? 0), 0)),
...
export function mechanismEvidenceValues(mechanismContext) {
  const teamValues = (team) => [
    ...
    team.shotsAtLeastPointTwoXg,
    team.expectedGoalsFromShotsAtLeastPointTwoXg,
