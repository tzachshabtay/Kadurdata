...
function validateArticle(article, filename) {
  ...
  if (article.generation?.mode !== "openai_analyst_writer_editor_and_qa") {
    fail("published article did not run the AI analyst-writer-editor-and-QA pipeline");
  }
  if (article.generation?.pipelineVersion !== "match-review-v19") fail("published article was not generated by the current pipeline version");
