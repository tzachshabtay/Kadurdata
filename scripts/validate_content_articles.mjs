...
function validateArticle(article, filename) {
  ...
  if (article.generation?.pipelineVersion !== "match-review-v11") fail("published article was not generated by the current pipeline version");
  ...
  for (const id of ["team.volume", "team.quality", "team.progression", "matchup.midfield", "matchup.home_attack_away_defense", "matchup.away_attack", "flow.shot_windows", "flow.game_state_context", "heatmap.spatial_profile"]) {
